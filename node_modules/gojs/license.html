...
<dl>
  ...
  <dt>&ldquo;Domain Name&rdquo;</dt><dd>means a unique name that identifies an Internet resource, such as a web site (e.g., <a href="https://nwoods.com">nwoods.com</a>).</dd>
...
<p>6.2 <u>Notices</u>.  Except as otherwise specifically set forth in this Agreement, all notices and other communications required to be given under this Agreement shall be in writing and shall be deemed to have been sufficiently given if sent by registered or certified mail, return receipt requested, or by a nationally recognized express courier.  Any such notice (a) if given to Northwoods, shall be sent to Northwoods at its address set forth on its web site (<a href="https://nwoods.com">https://nwoods.com</a> or any successor thereto), or (b) if given to Customer, shall be sent to Customer at its address set forth in the License-Specific Terms or such other address as Customer may have notified Northwoods in writing.</p>
...
<p>
  ...
  Internet: <a href="https://nwoods.com">https://nwoods.com</a><br>
